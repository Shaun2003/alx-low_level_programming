 ...
 *
 * Return: 0 if the first n bytes of s1 and s2 are equal, if not non-zero
 */
...
/**
 * _read - read from a file and print an error message on failure
 ...
 * @buffer: ELF header
 *
 * Return: 1 if big endian, if not 0
 */
...
/**
 * main - copy a file's info to another file
 * @argc: argument count
