...
/**
  * _binary_search - Search value in a sorted array
  * of digits using binary search
  ...
  * -1 if not, the index where the value is located
  *
...
/**
  * exponential_search - Search value in a sorted array
  * of digits using exponential search
  * @array: pointer to the first element of the array to search
